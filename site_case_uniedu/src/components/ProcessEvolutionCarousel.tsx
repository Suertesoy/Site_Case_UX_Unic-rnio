      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        @media (min-width: 1024px) {
          ...
          .marquee-track:hover .carousel-card:hover {
            ...
            box-shadow: 0 25px 50px -12px rgba(216, 27, 96, 0.25), 
                        0 0 0 1px rgba(216, 27, 96, 0.2);
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="relative">
          ...
          <button
            ...
            className="hidden lg:flex desktop-nav-btn absolute left-0 top-[200px] -translate-y-1/2 -translate-x-5 z-10 w-10 h-10 rounded-full bg-surface-elevated border border-border shadow-md items-center justify-center text-text-secondary hover:text-brand-strong hover:border-brand/30 transition-all duration-200 disabled:opacity-25 disabled:pointer-events-none cursor-pointer"
          >
          ...
          <button
            ...
            className="hidden lg:flex desktop-nav-btn absolute right-0 top-[200px] -translate-y-1/2 translate-x-5 z-10 w-10 h-10 rounded-full bg-surface-elevated border border-border shadow-md items-center justify-center text-text-secondary hover:text-brand-strong hover:border-brand/30 transition-all duration-200 disabled:opacity-25 disabled:pointer-events-none cursor-pointer"
          >
        ...
        <div className="mt-8 flex flex-col items-center gap-3 desktop-indicators">
